...
let g:navigator.s = {
            \ 'name': '+search',
            \ 's': ['menu_help#Fscope("s")', 'gscope-find-symbol'],
            \ 'g': ['menu_help#Fscope("g")', 'gscope-find-definition'],
            \ 'c': ['menu_help#Fscope("c")', 'gscope-find-calling'],
            \ 'd': ['menu_help#Fscope("d")', 'gscope-find-called'],
            \ 'e': ['menu_help#Fscope("e")', 'gscope-find-pattern'],
            \ 't': ['menu_help#Fscope("t")', 'gscope-find-text'],
            \ 'a': ['menu_help#Fscope("a")', 'gscope-find-assigned'],
            \ 'f': ['menu_help#Fscope("f")', 'gscope-find-file'],
            \ 'i': ['menu_help#Fscope("i")', 'gscope-find-include'],
            \ 'z': ['menu_help#Fscope("z")', 'gscope-find-ctags'],
            \ }
...
let g:navigator.x = {
            ...
            \ 'i': ['<key>:tabonly<cr>:h index<cr><c-w>o<c-w>v<leader>hk', 'init-layout'],
