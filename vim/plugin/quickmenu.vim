...
" 用于添加通过 <leader><leader> 触发的位于顶部的菜单栏
"
"======================================================================
...
call quickui#menu#install("&Edit", [
            ...
            \ ['&Break long line', 'call menu_help#SplitLine()', ''],
            \ ])

call quickui#menu#install('&Search', [
            \ [ "&Grep Word\t(In Project)", 'call module#action#grep()', 'Grep keyword in current project' ],
            \ [ "--", ],
            \ [ "Find &Definition\t(GNU Global)", 'call menu_help#Gscope("g")', 'GNU Global search g'],
            \ [ "Find &Symbol\t(GNU Global)", 'call menu_help#Gscope("s")', 'GNU Gloal search s'],
            \ [ "Find &Called by\t(GNU Global)", 'call menu_help#Gscope("d")', 'GNU Global search d'],
            \ [ "Find C&alling\t(GNU Global)", 'call menu_help#Gscope("c")', 'GNU Global search c'],
            \ [ "Find &From Ctags\t(GNU Global)", 'call menu_help#Gscope("z")', 'GNU Global search c'],
            \ [ "--", ],
...
call quickui#menu#install('&Tools', [
            ...
            \ ["Proxy E&nable", 'call menu_help#Proxy(1)', 'setup http_proxy/https_proxy/all_proxy'],
            \ ["Proxy D&isable", 'call menu_help#Proxy(0)', 'clear http_proxy/https_proxy/all_proxy'],
            \ ])

call quickui#menu#install('&Plugin', [
            \ ["&NERDTree\t<leader>tt", 'exec "NERDTreeToggle " . fnameescape(asclib#path#get_root("%"))', 'toggle nerdtree'],
            \ ["NERDTree &Focus\t<leader>to", 'NERDTreeFocus'],
...
let g:quickui_context = [
            \ ["&Peek Definition\tAlt+;", 'LspPeekDefinition'],
            \ ["S&earch in Project\t\\cx", 'exec "silent! GrepCode! " . expand("<cword>")'],
            \ [ "--", ],
            \ [ "Find &Definition\t\\cg", 'call menu_help#Fscope("g")', 'GNU Global search g'],
            \ [ "Find &Symbol\t\\cs", 'call menu_help#Fscope("s")', 'GNU Gloal search s'],
            \ [ "Find &Called by\t\\cd", 'call menu_help#Fscope("d")', 'GNU Global search d'],
            \ [ "Find C&alling\t\\cc", 'call menu_help#Fscope("c")', 'GNU Global search c'],
            \ [ "Find &From Ctags\t\\cz", 'call menu_help#Fscope("z")', 'GNU Global search c'],
            \ [ "--", ],
            \ [ "Goto D&efinition\t(LSP)", 'call module#lsp#goto_definition()'],
            \ [ "Goto &References\t(LSP)", 'call module#lsp#goto_references()'],
            \ [ "Goto Declara&tion\t(LSP)", 'call module#lsp#goto_declaration()'],
...
nnoremap <silent><leaeder>K :QuickUI context<cr>
...
if has('win32') || has('win64') || has('win16') || has('winxp')
    call quickui#menu#install('Help (&?)', [
                \ ['-'],
                \ ['&Content Win32', 'call menu_help#HelpList("h", g:help_content_win32)', ''],
                \ ])
endif
