...
"-----------------------------------------------------------------------
" hot keys
" 添加生成注释块、版权声明、主函数、modeline、时间戳等的快捷键映射
" 该快捷键映射需与函数定义在同一个文件中
"-----------------------------------------------------------------------
nnoremap <leader>e- :call <SID>snip_comment_block('-')<cr>
nnoremap <leader>e= :call <SID>snip_comment_block('=')<cr>
nnoremap <leader>e# :call <SID>snip_comment_block('#')<cr>
nnoremap <leader>ec :call <SID>snip_copyright('skywind')<cr>
nnoremap <leader>eb :call <SID>snip_bundle()<cr>
nnoremap <leader>em :call <SID>snip_main()<cr>
nnoremap <leader>el :call <SID>snip_modeline()<cr>
