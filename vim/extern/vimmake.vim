...
"   - VimScope command
"  
" 实现代码搜索、 tag 的快速生成与更新、 cscope 集成与符号查找。
" 需要安装 cscope 工具，universal-ctags 工具。
" 建议安装 vim-gutentags 插件，可以自动更新 ctags 文件。
" bundle_group 包含 tags 时，会安装 skywind3000/vim-gutentags 插件。
"======================================================================
