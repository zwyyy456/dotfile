...
"----------------------------------------------------------------------
" section 1, text starting with "#" represents a section
"----------------------------------------------------------------------
...
call quickmenu#append('Tag view', 'call quickui#tools#preview_tag(expand("<cword>"))', 'find (%{expand("<cword>")}) in ctags database')
